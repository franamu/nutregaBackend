...
/*=====  End of ACTUALIZAR LOGO  ======*/
	...
	static public function mdlActualizarScript($tabla, $id, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET apiFacebook = :apiFacebook, pixelFacebook = :pixelFacebook, googleAnalytics = :googleAnalytics , idApiFacebook = :idApiFacebook , versionApiFacebook = :versionApiFacebook WHERE id = :id");
		...
		$stmt->bindParam(":idApiFacebook", $datos["idApiFacebook"], PDO::PARAM_INT);
		$stmt->bindParam(":versionApiFacebook", $datos["versionApiFacebook"], PDO::PARAM_STR);
		$stmt->bindParam(":id", $id, PDO::PARAM_INT);
