...
$(".cambioScript").change(function(){
	...
	var idApiFacebook = $("#idFacebookApi").val();

	var versionApiFacebook = $("#versionFacebookApi").val();
	...
	$("#guardarScript").click(function(){
		...
		datos.append("idApiFacebook", idApiFacebook);
		datos.append("versionApiFacebook", versionApiFacebook);
...
$("input[name='modoPaypal']").on("ifChecked",function(){
	...
	$("#guardarInformacion").click(function(){
		...
		cambiarInformacion(modoPaypal, modoPayu , modoPaypal, modoPayu);
...
$(".cambioInformacion").change(function(){
	...
	console.log("Estado paypal: " , estadoPaypal);
	...
	console.log("Estado payu " , estadoPayu);
