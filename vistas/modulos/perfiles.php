  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <table class="table table-bordered table-striped dt-responsive tablaPerfilesAdm" width="100%">
                 ...
                 echo ' <tr>
                        ...
                        echo '<td>'.$value["perfil"].'</td>';
                         ...
                         if($value["estado"] != 0){
                          ...
                          echo '<td><button class="btn btn-success btn-xs btnActivarAdministradores" idPerfil="'.$value["id"].'" estadoPerfil="0">Activado</button></td>';

                        }else{

                          echo '<td><button class="btn btn-danger btn-xs btnActivarAdministradores" idPerfil="'.$value["id"].'" estadoPerfil="1">Desactivado</button></td>';
