	...
	<div class="box-body">
 		...
 		<div class="form-group">
            ...
            <div class="form-group">
                ...
                <label for="usr">ID api Facebook:</label>
                
                <div class="input-group">
                  
                  <span class="input-group-addon">#</span>
                  <input type="string" min="1" class="form-control cambioScript" id="idFacebookApi" value="">
            ...
            <div class="form-group">
                ...
                <label for="usr">Versión api Facebook:</label>
                
                <div class="input-group">
                  
                  <span class="input-group-addon">#</span>
                  <input type="string" min="1" class="form-control cambioScript" id="versionFacebookApi" value="">
