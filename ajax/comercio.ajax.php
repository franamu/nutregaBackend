...
class AjaxComercio{
	...
	public $idApiFacebook;
	public $versionApiFacebook;

	public function ajaxCambiarScript(){

		$datos = array("apiFacebook"=>$this->apiFacebook,
					   "pixelFacebook"=>$this->pixelFacebook,
					   "idApiFacebook"=>$this->idApiFacebook,
					   "versionApiFacebook"=>$this->versionApiFacebook,
...
if(isset($_POST["apiFacebook"])){
	...
	$script -> versionApiFacebook = $_POST["versionApiFacebook"];
	$script -> idApiFacebook = $_POST["idApiFacebook"];
