		...
		$item = null;
	 	...
	 	for($i = 0; $i < count($usuarios); $i++){
			...
			if($usuarios[$i]["foto"] != ""  && $usuarios[$i]["modo"] == "directo"){
				...
				$foto = "<img class='img-circle' src='https://ecommerce.ammu.com.ar/".$usuarios[$i]["foto"]."' width='60px'>";
			...
			/*=============================================
  			...
  			if($usuarios[$i]["modo"] == "directo"){
	  			...
	  			$estado = "<button class='btn btn-xs btnActivarUsuarios ".$colorEstado."' idUsuario='". $usuarios[$i]["id"]."' estadoUsuario='".$estadoUsuario."'>".$textoEstado."</button>";
